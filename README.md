##已停止更新！！谢谢大家的指正，请大家关注官方客户端源码，现在精力都已经移步到客户端的优化和重构中了，大部分最新的代码在net.oschina.app.improve包下，后期会完全摒弃老项目，重新架构，希望各位继续关注我们的工作。


#FlowGeek
FlowGeek是基于MVP架构的、遵循Material Design设计规范的开源中国社区客户端。

开源中国社区客户端自面世开源以来，	给很多初学者到来了很多帮助，感谢@火蚁 的工作。现在技术革新很厉害，而我们开源中国的社区app还一直停留在原始的样子，不断的收集大家的意见和issue，改改bug什么的，并没有做改版。其实到这，改版的理由已经很充足了，技术落后、界面难看、代码臃肿...但是各位老司机都应该清楚，改版这种事情是件工作量巨大的，理解业务逻辑、UI设计、架构设计、开源组件选择...所以，内部也是停留在想想的阶段。所幸来到开源中国，工作量（暂时）不大，还是比较轻松的，最近业界也津津乐道过MVP、Material Design一阵子，闲来无事，怀着一颗我不入地狱谁入地狱的决心，我就入坑了...

欢迎关注[React Native版](https://git.oschina.net/handoop/oschina_for_react_native)
##技术架构
...
##Feture
- **2016.08.14**: 社区app正在大面积修改，接口未来全部使用json传输数据，可能等待接口全部完成才会考虑是否继续工作。

- **2016.05.13更新**: 哈哈哈，我是来看捐赠功能的。[滑稽]
